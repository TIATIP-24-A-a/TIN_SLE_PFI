...
It appeared that the codes we created are too complicated for us explain. As well we were not able to prove whether the code worked properly or not and if the numbers are correct.
